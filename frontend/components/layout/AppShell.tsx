...
import {
  ...
  MessageSquare, LogOut, Menu, X, CalendarCheck, Trophy,
  type LucideIcon,
} from 'lucide-react';
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // staleTime=30s — a cache hit in the vast majority of renders
  ...
  return (
    <div className="flex min-h-screen" style={{ background: 'var(--bg-app)' }}>
      ...
      {/* Main */}
      {/* Bottom padding ensures content clears the fixed bottom nav on mobile */}
      <div className={cn(
        ...
        >
          <div className="flex items-center gap-3">
            ...
            {/* Page title visible on all screen sizes; match PAGE_TITLES lookup above */}
      ...
      {/* Mobile bottom nav — replaces the sidebar for small screens */}
      {!isSessionPage && (
        <nav
          ref={bottomNavRef}
