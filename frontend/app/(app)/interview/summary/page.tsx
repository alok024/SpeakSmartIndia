...
function InterviewSummaryPageInner() {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-2xl mx-auto space-y-5">
      ...
      {/* Header with score ring reveal + confetti burst on high score */}
      <div className="text-center py-4 relative overflow-visible">
        ...
        >
          ...
          {/* Confetti particles (rendered by CSS animation, shown for high scores) */}
          {avgScore >= 8 && (
      ...
      {/* Interviewer's Notes — short narrative summary
      ...
      {/* Per-question feedback with staggered scroll reveal */}
      {feedbacks.length > 0 && (
        <div className="space-y-4">
          ...
          {feedbacks.map((fb, i) => (
            ...
            <Card className="p-5 space-y-3">
              ...
              {/* Elara insight callout — shown when recurring pattern detected */}
      ...
      {/* Action button hierarchy — Practice Again is primary CTA */}
